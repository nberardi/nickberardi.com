...
As a long time [mysysgit](http://code.google.com/p/msysgit/) user for all my Git source control needs, I decided to find out if I could marry the two together to create a nice intersection between Console2 and msysgit's Bash client.  And after a bit of searching and stumbling on [my own post](/posts/adding-git-command-line-to-visual-studio/) about setting up the bash client in Visual Studio, I answered my own question on how to set it up for Console2.  Here is what I cam up with:
