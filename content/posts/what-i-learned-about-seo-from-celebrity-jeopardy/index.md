---
title: "What I learned about SEO from Celebrity Jeopardy!"
date: 2008-05-15T03:20:34-05:00
slug: "what-i-learned-about-seo-from-celebrity-jeopardy"
draft: false
tags:
  - "Celebrity Jeopardy"
  - "Jeopardy"
...
He falls on the side of [title case lettering and no hyphens splitting the words](http://codingsmarter.com/post/2008/05/MVC-Blogger-Project.aspx):

```
http://www.somesite.com/2008/05/HisURLPreferenceIsLikeThis/
```

He has his reasons I have mine, I just think mine are more valid. Sorry Al that is my opinion. I am going to layout why I think mine are more valid, with an example from Celebrity Jeopardy. For those of you who aren't familiar with [this famous skit](http://en.wikipedia.org/wiki/Celebrity_Jeopardy!_(Saturday_Night_Live)):

> ***Celebrity Jeopardy!*** was a recurring [sketch](http://en.wikipedia.org/wiki/Sketch_comedy "Sketch comedy") on *[Saturday Night Live](http://en.wikipedia.org/wiki/Saturday_Night_Live "Saturday Night Live")*. It [parodies](http://en.wikipedia.org/wiki/Parody "Parody") the [Celebrity *Jeopardy!*](http://en.wikipedia.org/wiki/Celebrity_Jeopardy%21 "Celebrity Jeopardy!") edition of the television [game show](http://en.wikipedia.org/wiki/Game_show "Game show") *[Jeopardy!](http://en.wikipedia.org/wiki/Jeopardy%21 "Jeopardy!")* where celebrities compete and the game's level of difficulty is significantly reduced. Thirteen sketches have been aired to date, two per season from 1996 to 2002, and one in 2005.
...
[![An Album Cover Google Example](/nickberardi.com/nickberardi.com/images/2008/05/an-album-cover-google-example1.png "An Album Cover Google Example")](http://www.google.com/search?q=an+album+cover+SNL)
