...
As you can see from the graph above everybody has helped make this another very successful year for Coder Journal.  The green line [is last years visitors](/posts/2007-year-end-reivew/), and the blue line is this years visitors.  This increase accounts for a **473.10%** increase over last years visits.  The following is a quick break down for what made this year so successful:

Top 6 posts:

1. [Setting up iTunes on Windows Vista 64-bit](/posts/setting-up-itunes-on-windows-vista-64-bit/) (#1 2007)
2. [iTunes 7.7 + Windows Vista x64 == OK](/posts/itunes-77-windows-vista-x64-ok/)
3. [Turn Google App Engine into your own Personal Content Delivery Network (CDN)](/posts/turn-google-app-engine-into-a-content-delivery-network-cdn/)
4. [5 Easy Steps To Get iTunes Working On Windows Vista x64](/posts/apple-wants-vista-to-run-un-secured-to-install-itunes/) (#2 2007)
5. [ASP.NET MVC CAPTCHA](/posts/aspnet-mvc-captcha/)
6. [How To: Change Instance Name Of SQL Server](/posts/how-to-change-instance-name-of-sql-server/)
